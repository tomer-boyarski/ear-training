...
class Question:
    ...
    def play_note(self, question_list):
        ...
        if number_of_questions_since_last_error == 0 or \
                number_of_questions_since_last_error == 1:
            self.note.index = question_list[-2].question.index
            self.step.size = question_list[-2].question.index - \
...
list_of_questions = [initial_question, initial_question]
